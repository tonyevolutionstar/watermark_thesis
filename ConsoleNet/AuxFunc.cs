...
namespace ConsoleNet
{
    public class AuxFunc
    {
        ...
        private readonly SQL_connection sql;
        public int h;
        public int w;
        private Dictionary<string, Point> circle_points;
        private List<string> combs;
        private readonly Commom commom;
        private readonly int numberPoints;

        private readonly int min_random = 10;
        private readonly int max_random = 70;
        private readonly string integrity_extension = "_";
